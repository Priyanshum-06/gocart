    ...
    return (
        <footer className="mx-6 mt-10">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 px-6 sm:px-8 rounded-3xl bg-white/80 backdrop-blur border border-slate-200 text-slate-600">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-800 tracking-tight">
                            <span className="text-teal-700">go</span>cart<span className="text-amber-500 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to gocart, your destination for smart everyday tech. From smartphones and wearables to practical accessories, find products built for real life.</p>
                ...
                <p className="py-4 text-sm text-slate-500 text-center">
                    Copyright 2026 © gocart. All rights reserved.
                </p>
            </div>
        </footer>
    );
